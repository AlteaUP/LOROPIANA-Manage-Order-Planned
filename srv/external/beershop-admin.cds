...
entity beershop_admin.Breweries {
  ...
  action draftPrepare(![in] : $self,
                      SideEffectsQualifier : LargeString) returns beershop_admin.Breweries;
  action draftActivate(![in] : $self)                     returns beershop_admin.Breweries;
  action draftEdit(![in] : $self,
                   PreserveChanges : Boolean)             returns beershop_admin.Breweries;
};
...
entity beershop_admin.TypeChecksWithDraft {
  ...
  action draftPrepare(![in] : $self,
                      SideEffectsQualifier : LargeString) returns beershop_admin.TypeChecksWithDraft;
  action draftActivate(![in] : $self)                     returns beershop_admin.TypeChecksWithDraft;
  action draftEdit(![in] : $self,
                   PreserveChanges : Boolean)             returns beershop_admin.TypeChecksWithDraft;
};
